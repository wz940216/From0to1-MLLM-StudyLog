...
def main():
    ...
    parser.add_argument("--config", default="week12_minillava_doc/code/config.yaml", help="训练配置文件路径")
    ...
    log_dir = config["TRAINING"]["LOGGING"].get("LOG_DIR", "week12_minillava_doc/outputs/logs")
