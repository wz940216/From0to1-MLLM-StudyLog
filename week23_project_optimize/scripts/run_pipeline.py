"""Local CLI for running the week23 optimized pipeline without FastAPI."""
...
def parse_args() -> argparse.Namespace:
    settings = Settings()
    parser = argparse.ArgumentParser(description="Run the week23 document QA pipeline.")
    ...
    parser.add_argument("--prompt-type", default="auto", choices=["auto", "general", "table", "heading", "summary"])
...
def main() -> None:
    ...
    if args.parse_only:
        ...
        payload.update(pipeline.last_parse_meta)
