...
class QwenVLDocumentQA:
    ...
    def build_messages(
        ...
        return [{"role": "user", "content": content}], [page.page_number for page in selected_pages]
    ...
    def answer(
        ...
        self.load()
        messages, selected_page_numbers = self.build_messages(artifacts, question, max_images, max_input_chars)
        ...
        return {"answer": output_text, "selected_pages": selected_page_numbers}
